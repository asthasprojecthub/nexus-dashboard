...
export const SectionCard = ({ number, title, subtitle, icon: Icon, color = 'blue', children, className = '' }) => {
  ...
  return (
    // <div className={`bg-white rounded-xl border ${c.ring} shadow-sm overflow-visible ${className}`}>
...
//       {open && (
//         <div className="absolute z-[9999] top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-xl">          {/* Search inside dropdown */}
//           <div className="p-2 border-b border-gray-100">
//             <div className="relative">
//               <Search size={13} className="absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-400" />
//               <input
